...
public class RecombeeController {
    ...
    @Operation(summary = "Record multiple view interactions")
    public ResponseEntity<ApiResponse<Void>> batchView(@Valid @RequestBody InteractionBatchRequest requests) {
